    ...
    <div className="about-us-container">
      ...
      <div className="company-overview">
        ...
        <p className="company-description">
          ...
          make your journey as smooth as possible, whether you need an economy
          car for a quick trip or a luxury vehicle for a special occasion.
        </p>
        <p className="company-mission">
          <strong>Mission:</strong> To provide exceptional car rental services
          that exceed customer expectations.
        </p>
        <p className="company-vision">
          <strong>Vision:</strong> To be the leading car rental company known
          for innovation, sustainability, and customer service excellence.
        </p>
      </div>
      ...
      <div className="car-variety-section">
        ...
        <p className="car-variety-description">
          We offer a wide variety of cars to suit every need. Choose from our
          economy cars for budget-friendly options, luxury vehicles for a touch
          of elegance, or SUVs for family trips and off-road adventures.
        </p>
      ...
      <div className="commitment-section">
        ...
        <p className="commitment-description">
          At CarRental Co., we are dedicated to providing outstanding customer
          service. We are committed to sustainability, with a growing fleet of
          electric and hybrid vehicles. Our 24/7 customer support ensures that
